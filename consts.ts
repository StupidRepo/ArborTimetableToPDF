...
export const API_V1_BASE_URL = "https://student-api.arbor.sc/student-app-api/v1/" // sorry, "/student-app-api/"?????
...
export namespace Networking {
	...
	export async function doAuthedNetworkRequest<T>(type: "POST" | "GET", url: string, body: any,
	                                                session: SchoolLogin.Response): Promise<T> {
